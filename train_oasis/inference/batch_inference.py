...
@torch.no_grad()
def vanilla():
    model_name = "pred_x" # "vanilla_10", "vanilla_20", "world_coordinate", "pred_x"
    inference_splits = ["random"] # ["memory", "random"]
    ddim_noise_steps = 20
    n_prompt_frames = 100
    video_offset = None
    batch_size = 10
    ...
    elif model_name == "vanilla_20" or model_name == "pred_x":
        model = DiT(
            input_h=18,
            input_w=32,
            in_channels=16,
    ...
    if "memory" in inference_splits:
        ...
        for info in memory_meta_data:
            ...
            if model_name == "vanilla_10" or model_name == "vanilla_20" or model_name == "pred_x":
