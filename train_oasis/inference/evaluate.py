...
def evaluate():
    ...
    model_names = ["rag_multi"]# ["lstm", "lstm_chunk", "lstm_long_term"] # ["vanilla_20_longer", "vanilla_40_direct_extrapolate", "frame_pack", "yarn", "historical_buffer", "rag", "infini_attn", "vanilla_10", "vanilla_20", "world_coordinate", "rag_pred_pose", "rag_multi_pred_pose"]
