...
def main(args):
    ...
    for start_idx in tqdm(range(0, len(items), args.batch_size), desc="dataset batches"):
        ...
        def generate_interval(x_state, target_len):
            """Generate frames until target_len (exclusive upper-bound style)."""
            x_gen = x_state.clone()
        ...
        def refine_tail(x_state):
            """Final tail refinement once all frames are generated."""
            x_ref = x_state.clone()
        ...
        # Interval BoN: select best particle repeatedly every chunk.
        x_best = x.clone()
        ...
        while cur_len < total_frames:
            ...
            for p in range(args.num_particles):
                ...
                for b in range(B):
                    ...
                    print(
                        ...
                        f"len={target_len} particle={p} seed={seed} score={score}"
                    )
            ...
            for b in range(B):
                ...
                print(
                    ...
                    f"particle={best_idx} score={best_score:.6f}"
                )
        ...
        # Final tail refinement and save.
...
if __name__ == "__main__":
    ...
    parse.add_argument(
        ...
        type=int,
        default=4,
        help="Number of action dimensions per frame (must match checkpoint; e.g. 6 for dit_easy_6).",
    )
    parse.add_argument(
        "--vae-ckpt",
        type=str,
